...
@section('content')
    <tr>
        <td style="line-height: 24px; font-size: 15px; width: 100%; margin: 0; padding: 40px;" align="left" bgcolor="#ffffff">
            <h1 class="h3 fw-700" style="padding-top: 0; padding-bottom: 0; font-weight: 700 !important; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;" align="left">Thank you for your order!</h1>
            ...
            <p style="line-height: 24px; font-size: 15px; width: 100%; margin: 0;" align="left">
                Hi {{ $order->billing_first_name }}, we've received your order and it's now being processed.
            </p>
            ...
            <h2 style="font-size: 18px; font-weight: 700; margin: 0 0 12px;">Shipping To</h2>
