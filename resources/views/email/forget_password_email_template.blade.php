    ...
    <tr>
        <td style="line-height: 24px; font-size: 15px; width: 100%; margin: 0; padding: 40px;" align="left" bgcolor="#ffffff">
            <h1 class="h3 fw-700" style="padding-top: 0; padding-bottom: 0; font-weight: 700 !important; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;" align="left">
                You are requested to reset your password
            </h1>
            ...
            <p class="" style="line-height: 24px; font-size: 15px; width: 100%; margin: 0;" align="left">
                ...
                reset is only valid for the next 24 hours.
            </p>
            <br>
            <table class="s-4 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                <tbody>
            ...
            <table class="ax-center" role="presentation" align="center"  border="0" cellpadding="0" cellspacing="0" style="border-radius: 6px; border-collapse: separate !important; font-weight: 700 !important;">
                ...
                <tr>
                    <td style="line-height: 24px; font-size: 15px; border-radius: 6px; font-weight: 700 !important; margin: 0;" align="center" bgcolor="#0d6efd">
                        <a href="{{ $details['link'] }}" style="color: #ffffff; font-size: 15px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: block; font-weight: 700 !important; white-space: nowrap; background-color: #0d6efd; padding: 12px; border: 1px solid #0d6efd;">Set new password</a>
                    </td>
                </tr>
                </tbody>
            </table>
...
{{--            </p>--}}
            <br>
            <small>*If you did not request to reset your password, ignore this email and the link will exoire on its own.</small>
            <br>
            <p>
                Thanks,<br>
