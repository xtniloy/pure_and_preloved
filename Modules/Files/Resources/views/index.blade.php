...
@section('content')
    <div class="px-4">
        <div class="fs-2 fw-semibold mb-2">File Manager</div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item"><a href="#" data-coreui-i18n="home">Dashboard</a></li>
                <li class="breadcrumb-item active"><span>File Uploader</span></li>
            </ol>
        </nav>
